    ...
    <main className="p-6 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button onClick={() => { setOpenNew(true); resetForm(); }} className="px-3 py-2 rounded bg-brand-500 text-white transition-transform duration-200 hover:scale-105">New Project</button>
        </div>
      </div>
